...
namespace Augury.RepairTelemetryService.Services
{
    public class ConsulHostedService : IHostedService
    {
        private const string ServiceName = "machine-repair-feed-service";
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Machine Repair Service is running on: {_hostname}:{_port}");
            ...
            var registration = new AgentServiceRegistration
            {
                ...
                Tags = new[] { "api", "machine-repair-feed" }
            };
        ...
        {
            _logger.LogInformation($"Machine Repair Service is shutting down: {_hostname}:{_port}");
